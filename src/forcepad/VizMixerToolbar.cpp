...
static Fl_Image *image_stress2_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_stress2_black);
  return image;
}
...
static Fl_Image *image_displacements_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_displacements_black);
  return image;
}
...
static Fl_Image *image_stress_mises_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_stress_mises_black);
  return image;
}
...
static Fl_Image *image_tension_compression_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_tension_compression_black);
  return image;
}
...
static Fl_Image *image_tension_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_tension_black);
  return image;
}
...
static Fl_Image *image_compression_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_compression_black);
  return image;
}
...
static Fl_Image *image_colormap2_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_colormap2_black);
  return image;
}
...
static Fl_Image *image_colormap3_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_colormap3_black);
  return image;
}
...
static Fl_Image *image_action_move_force_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_action_move_force_black);
  return image;
}
...
static Fl_Image *image_action_rotate_force_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_action_rotate_force_black);
  return image;
}
