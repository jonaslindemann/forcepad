  ...
  { mainWindow = new Fl_Double_Window(318, 244, "Calculation Settings");
    ...
    { Fl_Tabs* o = new Fl_Tabs(7, 5, 303, 202);
      ...
      { meshGroup = new Fl_Group(12, 26, 294, 176, "Mesh");
        ...
        { warnOnLargeModel = new Fl_Check_Button(97, 135, 145, 25, "Warn on large models");
          warnOnLargeModel->down_box(FL_DOWN_BOX);
          warnOnLargeModel->value(1);
          warnOnLargeModel->color(FL_FOREGROUND_COLOR);
          warnOnLargeModel->labelsize(11);
          warnOnLargeModel->labelcolor(FL_BACKGROUND2_COLOR);
