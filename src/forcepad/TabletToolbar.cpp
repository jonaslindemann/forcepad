...
static Fl_Image *image_open_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_open_black);
  return image;
}
...
static Fl_Image *image_new_model_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_new_model_black);
  return image;
}
...
static Fl_Image *image_save_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_save_black);
  return image;
}
...
static Fl_Image *image_undo_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_undo_black);
  return image;
}
...
static Fl_Image *image_settings_black() {
  static Fl_Image *image = new Fl_Pixmap(idata_settings_black);
  return image;
}
...
CTabletToolbar::CTabletToolbar() {
  { mainWindow = new Fl_Double_Window(232, 49, "Tablet Toolbar");
    ...
    { btnSaveAs = new Fl_HoverButton(95, 3, 42, 42);
      ...
      btnSaveAs->align(Fl_Align(FL_ALIGN_CENTER));
