...
#define FORCEPAD_VERSION_MINOR 5
#define FORCEPAD_VERSION_RELEASE 0
#define FORCEPAD_QT

#define FORCEPAD_VERSION_STRING "ForcePAD version 2.5.0"

#define FORCEPAD_NAME "ForcePAD 2 - (2.5.0)"

#define so_print(a,b) std::cout << a << " : " << b << endl;
